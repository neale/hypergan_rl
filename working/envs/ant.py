...
def get_state_block(state):
    ...
    if y_block == 'low' and x_block == 'left':
        return 0
    elif y_block == 'low' and x_block == 'center':
        return 1
    elif y_block == 'low' and x_block == 'right':
        return 2
    elif y_block == 'mid' and x_block == 'right':
        return 3
    elif y_block == 'high' and x_block == 'right':
        return 4
    elif y_block == 'high' and x_block == 'center':
        return 5
    elif y_block == 'high' and x_block == 'left':
        return 6
